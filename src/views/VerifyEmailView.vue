  ...
  <div class="min-h-screen bg-gray-900 flex items-center justify-center px-4">
    <div class="max-w-md w-full bg-gray-800 rounded-lg p-8 shadow-xl">
      <div class="text-center mb-8">
        ...
        <p class="text-gray-400">Ingresa tu email para recibir un código de verificación</p>
      </div>
...
const handleSubmit = async () => {
  try {
    ...
    success.value = 'Si el email existe, recibirás un código de verificación.'
    ...
    error.value = err instanceof Error ? err.message : 'Error al enviar el código'
